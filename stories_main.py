...
#pickle.dump(words, open('stories_words.pkl', 'wb'))
#pickle.dump(classes, open('stories_classes.pkl', 'wb'))

# Based on Latest Updated Data
pickle.dump(words, open('updated_intents_words.pkl', 'wb'))
pickle.dump(classes, open('updated_intents_classes.pkl', 'wb'))
...
# Based on Latest Updated Data
model.save('updated_stories_chatbot_model.h5', hist)
